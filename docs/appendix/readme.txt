...
4. 出图：cd Q1 && python plot_question1.py；cd Q2 && python plot_question2.py；
   ...
   cd Q2 && mmdc -i 问题2_接触网络_机理示意.mmd -o figures/问题2_接触网络_机理示意.png -b white -s 2
   （图9 机理流程图，mermaid CLI 渲染；另输出 .pdf 矢量版）
...
Q2/问题2_接触网络_机理示意.mmd             图9 接触网络导通判定机理流程（mermaid 源，AI 辅助注释头在源文件 frontmatter 外；mmdc 渲染 png/pdf 双格式）
