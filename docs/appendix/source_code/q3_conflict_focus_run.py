"""Run the Q3 conflict-focused search without replacing formal archives.

The current strict archive is the incumbent. Verified candidates and a run
summary are written under outputs/workbooks/q3/conflict_focus_runs/.
"""
...
# Installs the lightweight Q1 data helpers before importing Q3.io. This keeps
# the continuation run independent of optional Q1 solver packages.
...
def run_case(case: str, budget_s: int, top_edges: int, run_dir: Path) -> dict:
    ...
    # Keep local-search checkpoints out of the repository output tree. Only a
    # fully verified final candidate is copied into run_dir below.
