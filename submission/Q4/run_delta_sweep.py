...
M_FAST = 4000
M_STRICT = 4000
VERIFY_SEED = 42 + 12345
BASE_SEED_STRICT = 20260808
...
def run_strict_point(delta):
    ...
    sys.path.insert(0, HERE)
    sys.path.insert(0, os.path.join(ROOT, 'Q2'))
    import run_strict_mixed_audit as rsa
